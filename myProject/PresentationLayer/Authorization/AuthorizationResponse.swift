...
final class AuthorizationResponse {
    ...
    func setupToken(code: String, completion: @escaping (TokenModel) -> Void) {
        ...
        let setupUrl: [String: Any] = [
            ...
            "redirect_uri": "https://chto-takoe-lyubov.net/wp-content/uploads/2015/11/belyy-tsvet-stikhi.jpg",
            "grant_type": "authorization_code",
            "code": "\(code)"
            
        ]
        
        AF.request("https://unsplash.com/oauth/token", method: .post, parameters: setupUrl).response { data in
